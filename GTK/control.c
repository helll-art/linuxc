/*************************************************************************
	...
	> Author: 
	> Mail: 
	> Created Time: 2020年07月18日 星期六 15时15分44秒
 ************************************************************************/
...
int main(int argc,char **argv)
{
    ...
    //创建进度条
    ajustment = gtk_adjustment_new(70.0,0.0,100.0,1.0,0.0,0.0);
    var = gtk_progress_bar_new_with_adjustment(GTK_ADJUSTMENT(adjustment));
